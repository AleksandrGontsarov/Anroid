...
public class WorkoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        workoutType = getIntent().getIntExtra(Workout.WORKOUT_TYPE_KEY, 0);
    ...
    private void initUI() {
        repeatCount = WorkoutList.getInstance().getWorkoutsList().get(workoutType).getRepCount();
        ...
        workoutTitleTextView.setText(WorkoutList.getInstance().getWorkoutsList().get(workoutType).getTitle());
        ...
        descriptionTextView.setText(WorkoutList.getInstance().getWorkoutsList().get(workoutType).getDescription());

        completeButton = (Button) findViewById(R.id.completeButton);
        completeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WorkoutList.getInstance().getWorkoutsList().get(workoutType).setRepCount(repeatCount);
                setResult(RESULT_OK);
                finish();
            }
        });
